...
import com.evento.backend.service.EventoTipoService;
...
/**
 * REST controller for managing {@link com.evento.backend.domain.EventoTipo}.
 */
@RestController
...
public class EventoTipoResource {
    ...
    public ResponseEntity<EventoTipoDTO> createEventoTipo(@Valid @RequestBody EventoTipoDTO eventoTipoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/evento-tipos/" + eventoTipoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, eventoTipoDTO.getId().toString()))
            .body(eventoTipoDTO);
    }
    ...
    public ResponseEntity<EventoTipoDTO> updateEventoTipo(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, eventoTipoDTO.getId().toString()))
            .body(eventoTipoDTO);
    }
    ...
    public ResponseEntity<EventoTipoDTO> partialUpdateEventoTipo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, eventoTipoDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public List<EventoTipoDTO> getAllEventoTipos() {
