...
import com.evento.backend.config.Constants;
import com.evento.backend.domain.User;
import com.evento.backend.repository.UserRepository;
import com.evento.backend.security.AuthoritiesConstants;
import com.evento.backend.service.MailService;
import com.evento.backend.service.UserService;
import com.evento.backend.service.dto.AdminUserDTO;
import com.evento.backend.web.rest.errors.BadRequestAlertException;
import com.evento.backend.web.rest.errors.EmailAlreadyUsedException;
import com.evento.backend.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.evento.backend.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
