package com.evento.proxy.security.jwt;

import static com.evento.proxy.security.AuthoritiesConstants.ADMIN;
import static com.evento.proxy.security.SecurityUtils.AUTHORITIES_CLAIM;
import static com.evento.proxy.security.SecurityUtils.JWT_ALGORITHM;
